...
parser.add_argument('--node1minAddr', type=int, default=100 * 1024 * 1024)
parser.add_argument('--node2minAddr', type=int, default=200 * 1024 * 1024)
parser.add_argument('--node3minAddr', type=int, default=300 * 1024 * 1024)
parser.add_argument('--node4minAddr', type=int, default=400 * 1024 * 1024)
parser.add_argument('--node1maxAddr', type=int, default=200 * 1024 * 1024)
parser.add_argument('--node2maxAddr', type=int, default=300 * 1024 * 1024)
parser.add_argument('--node3maxAddr', type=int, default=400 * 1024 * 1024)
parser.add_argument('--node4maxAddr', type=int, default=500 * 1024 * 1024)
...
print("\tCreating l1_cache_%d_l2_cache_%d_link"%(pe_id, pe_id))
connect("l1_cache_%d_bus_%d_link"%(pe_id, pe_id),
        l1_cache, "low_network_0",
        bus, "high_network_1",
        ring_latency).setNoCut()

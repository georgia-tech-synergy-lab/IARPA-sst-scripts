...
arbiter2_params = {
    "arbiter_frequency": core_clock,
    "port1minAddr": args.node4minAddr,
    "port2minAddr": args.node5minAddr,
    "port3minAddr": args.node6minAddr,
    "port1maxAddr": args.node4maxAddr,
    "port2maxAddr": args.node5maxAddr,
    "port3maxAddr": args.node6maxAddr,
}

arbiter3_params = {
    "arbiter_frequency": core_clock,
    "port1minAddr": args.node7minAddr,
    "port2minAddr": args.node8minAddr,
    "port3minAddr": args.node9minAddr,
    "port1maxAddr": args.node7maxAddr,
    "port2maxAddr": args.node8maxAddr,
    "port3maxAddr": args.node9maxAddr,
}
...
gen.addParams({
    "seed_a"                     : 10,
    "seed_b"                     : 11,
    "avoid_addr_range_min_value" : args.node1minAddr,
    "avoid_addr_range_max_value" : args.node1maxAddr,
    "avoid_addr_range_min_value1" : args.node5minAddr,
    "avoid_addr_range_max_value1" : args.node5maxAddr,
    "avoid_addr_range_min_value2" : args.node9minAddr,
    "avoid_addr_range_max_value2" : args.node9maxAddr,
...
#        ring_latency).setNoCut()
#
#print("\t\tCreating l2_cache_%d_arbiter_%d_link"%(pe_id, rtr_id))
#connect("l2_cache_%d_arbiter_%d_link"%(pe_id, rtr_id),
#        l2_cache, "low_network_0",
#        arbiter, "port1",
#        ring_latency)
